...
fatec_movimento.to_excel('Dados/Complementares/fatec_mvt.xlsx', sheet_name = 'Tabela 1', index = False)
fatec_pagamento.to_excel('Dados/Complementares/fatec_pgt.xlsx', sheet_name = 'Tabela 1', index = False)